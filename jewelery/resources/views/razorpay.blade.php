...
window.location.href = SITEURL +'/'+ 'paysuccess?payment_id='+response.razorpay_payment_id+'&product_id='+product_id+'&amount='+totalAmount+'&order_id='+order_id+'&signature='+response.razorpay_payment_signature;
},
"prefill": {
"contact": '9988665544',
